...
## Created in pathway_enrichment_aNSC_vs_qNSC_only_young.R:
load("Results/kegg_results_aNSC_vs_qNSC_deseq_only_young_with_replicate.RData")
...
## Results from the young pooled samples for order:
...
pdf("Results/pathway_enrichment_aNSC_vs_qNSC_only_young_barplot.pdf", width = 7, height = 8.5)
