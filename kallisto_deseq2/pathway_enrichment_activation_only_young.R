...
## Created in deseq2_testing_activation_only_young.R:
load("Data/activation_results_deseq_only_young_with_replicate.RData")
...
save(kegg.results,
     file = "Results/kegg_results_activation_deseq_only_young_with_replicate.RData")

write.table(kegg.results$pathway.results,
            col.names = NA,
            quote = FALSE,
            sep = "\t",
            file = "Results/kegg_results_activation_deseq_only_young_with_replicate.txt")
