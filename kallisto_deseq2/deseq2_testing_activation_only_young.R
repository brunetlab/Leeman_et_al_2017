...
dds.deseq <- DESeq(dds)
save(dds.deseq,
     file = "Data/dds_deseq_activation_only_young_with_replicate.RData")
...
save(activation.results.deseq,
     file = "Data/activation_results_deseq_only_young_with_replicate.RData")
